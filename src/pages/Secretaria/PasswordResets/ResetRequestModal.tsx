                ...
                {!isSearching && searchQuery && !foundUser && (
                  <div className="bg-destructive/5 border border-destructive/20 rounded-lg p-4">
                    <div className="flex items-center gap-2">
                      ...
                      <p className="text-sm text-destructive">Email não encontrado no sistema</p>
                    </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-3">
                  <div className="flex gap-2">
                    <Button onClick={generateRandomPassword} variant="outline" className="flex-1">
                      Gerar senha temporária
                    </Button>
                    {newPassword && (
                      <Button onClick={() => copyToClipboard(newPassword)} variant="outline" size="icon">
                  ...
                  {newPassword && confirmPassword && newPassword !== confirmPassword && (
                    <div className="text-sm text-destructive">As senhas não coincidem</div>
                  )}
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between p-3 bg-muted/50 rounded-lg">
                  ...
                  <Switch checked={requiresChange} onCheckedChange={setRequiresChange} />
                </div>
                ...
                {foundUser && (
                  <div className="bg-primary/5 border border-primary/20 rounded-lg p-3">
                    ...
                    <ul className="text-sm text-muted-foreground space-y-1">
                      <li>
                        • Usuário: {foundUser.name} ({foundUser.role})
                      </li>
          ...
          <div className="flex gap-2">
            ...
            {currentStep < 3 ? (
              <Button
                ...
                disabled={(currentStep === 1 && !foundUser) || (currentStep === 2 && !isPasswordValid())}
              >
                Próximo
              </Button>
            ) : (
              <Button onClick={handleSavePassword} disabled={isProcessing || !foundUser || !isPasswordValid()}>
                {isProcessing ? (
                  <>
