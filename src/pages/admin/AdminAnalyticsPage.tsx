                ...
                <TooltipProvider>
                  <Tooltip>
                    ...
                    <TooltipContent className="max-w-md">
                      <p className="text-xs">
                        Visualize os horários e dias da semana com maior atividade no sistema. Identifique padrões de uso de alunos e professores para otimizar comunicações e publicações.
                      </p>
                    </TooltipContent>
                  </Tooltip>
                </TooltipProvider>
              ...
              <h3 className="font-bold text-lg mb-1 flex items-center justify-center gap-2">
                ...
                <TooltipProvider>
                  <Tooltip>
                    ...
                    <TooltipContent className="max-w-md">
                      <p className="text-xs">
                        Monitore a taxa de retenção de alunos e identifique tendências de evasão. Analise o ciclo de vida dos alunos desde a matrícula até conclusão ou saída.
                      </p>
                    </TooltipContent>
                  </Tooltip>
                </TooltipProvider>
              ...
              <h3 className="font-bold text-lg mb-1 flex items-center justify-center gap-2">
                ...
                <TooltipProvider>
                  <Tooltip>
                    ...
                    <TooltipContent className="max-w-md">
                      <p className="text-xs">
                        Acompanhe a eficiência operacional da instituição: ocupação de turmas, capacidade, e aproveitamento de recursos. Identifique oportunidades de otimização.
                      </p>
                    </TooltipContent>
                  </Tooltip>
                </TooltipProvider>
              ...
              <h3 className="font-bold text-lg mb-1 flex items-center justify-center gap-2">
                ...
                <TooltipProvider>
                  <Tooltip>
                    ...
                    <TooltipContent className="max-w-md">
                      <p className="text-xs">
                        Índice proprietário que consolida múltiplas métricas em um único indicador de saúde institucional. Pontuação de 0-100 baseada em engajamento, desempenho e eficiência operacional.
                      </p>
                    </TooltipContent>
                  </Tooltip>
                </TooltipProvider>
