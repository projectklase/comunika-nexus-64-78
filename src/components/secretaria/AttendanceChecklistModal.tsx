...
export function AttendanceChecklistModal({ open, onOpenChange, eventId, eventTitle }: AttendanceChecklistModalProps) {
  ...
  const exportAttendanceListXLSX = async () => {
    ...
    try {
      ...
      row7.getCell("I").value = { formula: `COUNTIF(B4:B${lastDataRow}, "ALUNO")` };
      ...
      row8.getCell("I").value = { formula: `COUNTIF(B4:B${lastDataRow}, "CONVIDADO")` };
      ...
      row11.getCell("I").value = { formula: `COUNTIFS(B4:B${lastDataRow}, "ALUNO", F4:F${lastDataRow}, "Presente")` };
      ...
      row12.getCell("I").value = { formula: `COUNTIFS(B4:B${lastDataRow}, "CONVIDADO", F4:F${lastDataRow}, "Presente")` };
      ...
      row13.getCell("I").value = { formula: `COUNTIF(F4:F${lastDataRow}, "Presente")` };
      ...
      row14.getCell("I").value = { formula: `COUNTIF(F4:F${lastDataRow}, "Ausente")` };
