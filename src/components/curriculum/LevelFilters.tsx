...
import type { LevelFilters } from '@/types/curriculum';
...
interface LevelFiltersProps {
  ...
  onFiltersChange: (filters: LevelFilters) => void;
}

export function LevelFilters({ filters, onFiltersChange }: LevelFiltersProps) {
