      ...
      <div className="glass-card p-4 rounded-xl border border-border/50 space-y-4">
        <div className="flex items-center gap-4 flex-wrap">
          ...
          <div className="relative flex-1 min-w-[200px]">
            ...
            <Input
              placeholder="Buscar por título, autor ou turma..."
              value={searchInput}
          ...
          >
            <SelectTrigger 
              className="w-[180px] bg-background/50 border-border/50 focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
