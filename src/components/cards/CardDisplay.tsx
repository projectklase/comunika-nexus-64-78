...
export const CardDisplay = ({ 
  ...
  // Touch handlers for mobile devices - NÃO previne scroll do modal
  ...
  return (
    <div
      ...
      className={cn(
        'relative rounded-xl overflow-hidden cursor-pointer touch-manipulation',
      ...
      <div className={cn(
        ...
        <div className={cn(
          ...
          {quantity !== undefined && quantity > 1 && (
            <div className="absolute bottom-2 right-2 bg-black/90 rounded-full w-6 h-6 flex items-center justify-center font-bold text-xs border-2 border-yellow-400 text-yellow-400 shadow-[0_0_8px_rgba(234,179,8,0.5)] z-30">
              {quantity}
            </div>
          )}
        </div>
