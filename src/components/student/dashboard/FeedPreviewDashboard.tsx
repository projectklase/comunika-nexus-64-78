    ...
    return (
      <Card className="glass-card border-border/50">
        <CardHeader>
          ...
          <CardDescription>Novos posts e comunicados</CardDescription>
        </CardHeader>
  ...
  return (
    <Card className="glass-card border-border/50">
      <CardHeader>
        ...
        <CardDescription>Novos posts e comunicados da sua escola</CardDescription>
      </CardHeader>
        ...
        {recentPosts.map((post) => (
          ...
          >
            <div className="flex items-start gap-3">
              <div
                className={cn("flex items-center justify-center w-10 h-10 rounded-lg border", getTypeColor(post.type))}
              >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  {post.meta?.important && (
                    <Badge className="text-xs bg-[hsl(var(--golden))]/20 text-[hsl(var(--golden))] border-[hsl(var(--golden))]/30">
                      ⭐ Importante
                    </Badge>
                  )}
                </div>

                <h4 className="font-medium text-sm text-foreground mb-1 truncate">{post.title}</h4>

                <p className="text-xs text-muted-foreground mb-2 line-clamp-2">{getContentPreview(post)}</p>
                ...
                <div className="flex items-center justify-between text-xs text-muted-foreground">
                  ...
                  {post.classId && <span>Turma {post.classId.slice(-4)}</span>}
                </div>
              </div>
