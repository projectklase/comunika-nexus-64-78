-- Add starter pack flag to profiles
ALTER TABLE profiles
ADD COLUMN IF NOT EXISTS has_received_starter_pack BOOLEAN DEFAULT FALSE;

-- Update RPC to support free packs
