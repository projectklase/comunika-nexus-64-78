-- Update the auto_archive_expired_posts function to handle CONCLUDED status
-- CONCLUDED posts will be archived after 10 days
-- ARCHIVED posts will be deleted after 30 days
...
BEGIN
  ...
  -- Only delete if they have been archived for 30 days (checking updated_at as archive timestamp)
  ...
  -- Phase 3: Auto-archive expired PUBLISHED posts (existing logic)
  ...
  -- AVISO/COMUNICADO: 30 days after creation
