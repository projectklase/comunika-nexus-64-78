-- Corrigir cálculo da semana na função get_last_weekly_prize_results
-- ÚNICA MUDANÇA: linha de cálculo v_last_week_start
-- ANTES (BUG): date_trunc('week', CURRENT_DATE - INTERVAL '1 day')::DATE
-- AGORA: Subtrair 7 dias da segunda-feira da semana atual
...
DECLARE
  ...
  v_my_prize INT;
BEGIN
  -- CORREÇÃO: Calcular segunda-feira da semana ANTERIOR corretamente
  v_last_week_start := (date_trunc('week', CURRENT_DATE) - INTERVAL '7 days')::DATE;
