-- Balanceamento de Efeitos Elementais por Raridade
-- FREEZE: cooldown baseado em raridade (COMMON nunca congela, RARE 3 turnos, EPIC 2 turnos, LEGENDARY 1 turno)
-- HEAL: limite máximo por raridade (COMMON 3 HP, RARE 5 HP, EPIC 10 HP, LEGENDARY 15 HP)
...
DECLARE
  ...
  v_trap_name TEXT;
  v_new_effects JSONB;
  -- NOVAS VARIÁVEIS PARA BALANCEAMENTO POR RARIDADE
