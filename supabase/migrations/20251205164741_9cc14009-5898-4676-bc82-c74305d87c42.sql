-- =============================================
-- SECURITY FIX: Mutable search_path vulnerabilities
-- =============================================

-- 1. Fix open_card_pack function - Add SET search_path TO 'public'
...
-- 2. Fix update_challenges_updated_at trigger function - Add SET search_path TO 'public'
...
-- 3. Move pg_net extension to dedicated schema
