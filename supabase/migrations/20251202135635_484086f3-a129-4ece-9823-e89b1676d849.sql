-- Sistema Hearthstone: Monstros agora têm HP (baseado em DEF) e combate causa dano simultâneo

-- Atualizar play_card para adicionar current_hp ao monstro
  ...
  ELSE
    ...
    v_game_state := jsonb_set(
      ...
      jsonb_build_object(
        ...
        'atk', v_card.atk,
        'def', v_card.def,
        'current_hp', v_card.def,  -- HP inicial = DEF
        'max_hp', v_card.def,      -- HP máximo = DEF
        'effects', v_card.effects,
        'image_url', v_card.image_url,
        'rarity', v_card.rarity
      )
...
-- Atualizar attack para sistema Hearthstone: combate simultâneo com HP
