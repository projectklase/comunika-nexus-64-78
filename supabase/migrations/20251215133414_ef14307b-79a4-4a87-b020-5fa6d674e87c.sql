-- Restaurar função attack() completa com overflow damage, logs completos e XP 10/3
-- A versão em 20251215130846 estava quebrada - faltava overflow damage e campos de log
